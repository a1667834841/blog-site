...
title: "InnoDB数据页结构"
slug: "innodb数据页结构"
date: "2022-02-13T18:50:17+08:00"
lastmod: "2022-02-13T18:50:17+08:00"
draft: false
summary: ""
description: ""
source:
...
记录根据记录头中的，next_record连接成单向链表，并且会被分为组，组内的记录个数不超过8个，查找时利用二分查找，页中不仅包含记录数据还包含fileHeader,利用fileHeader中，pre_page和next_page可以将页连接成双向链表。
